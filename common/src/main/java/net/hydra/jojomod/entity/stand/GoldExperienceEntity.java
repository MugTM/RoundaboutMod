...
public class GoldExperienceEntity extends FollowingStandEntity {



    public GoldExperienceEntity(EntityType<? extends Mob> entityType, Level world) {
    ...
    public static Component getSkinNameT(byte skinId) {
        switch (skinId)
        {
            case PART_5 -> {return Component.translatable("skins.roundabout.golden_experience.base");}
        }
        return Component.translatable("skins.roundabout.gold_experience.base");
    }
